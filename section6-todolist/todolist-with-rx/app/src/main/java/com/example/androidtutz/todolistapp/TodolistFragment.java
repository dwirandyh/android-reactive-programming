    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        disposable.add(
                RxTextView.textChangeEvents(searchEditText)
                        ...
                        .skipInitialValue()
                        // to give time out, to avoid request data every single character change
                        .debounce(300, TimeUnit.MICROSECONDS)
                        // to avoid duplicate value when text change
    ...
    private void loadData() {
        ...
        disposable.add(
                observable
                        .subscribeOn(Schedulers.io())
                        .observeOn(AndroidSchedulers.mainThread())
                        // Filter data berdasarkan taskstatus apakah sedang archiving atau archived
